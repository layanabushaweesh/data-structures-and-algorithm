...
const addPurchases = (arr) => {
  // Solution code here...
  return arr.reduce((total, item) => {total = total + item.purchasePrice; return total;}, 0);
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  return arr.reduce((arrLength) => 
  {return arrLength = arrLength + 1;});
...
const returnNames = (arr) => {
  // Solution code here...
  return arr.reduce((arrNames, item) => {arrNames.push(item.name); return arrNames;}, []);
...
const reversedString = (str) => {
  ...
  return arrStr.reduce((reverse, element) => {return element + reverse;}, '');
